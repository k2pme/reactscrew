...
export type ScrewRoute<TArgs extends unknown[] = unknown[]> = string | ((...args: TArgs) => string);
...
export type QueryKeyFactory<TArgs extends unknown[] = unknown[]> = (context: QueryKeyContext<TArgs>) => QueryKey;
export interface BaseMethodDefinition<TArgs extends unknown[] = unknown[], TData = unknown> {
    ...
    onSettled?: (data: TData | undefined, error: ReactScrewErrorShape | null) => void | Promise<void>;
}
export interface QueryDefinition<TArgs extends unknown[] = unknown[], TData = unknown> extends BaseMethodDefinition<TArgs, TData> {
    type?: 'query';
...
export interface MutationDefinition<TArgs extends unknown[] = unknown[], TData = unknown, TVariables = unknown> extends BaseMethodDefinition<TArgs, TData> {
    type?: 'mutation';
    bodyValidator?: RuntimeValidator<TVariables>;
    invalidateQueries?: QueryInvalidationTarget[];
    optimisticUpdate?: (context: OptimisticUpdateContext<TVariables>) => Promise<RollbackAction | void> | RollbackAction | void;
}
export type ScrewMethodDefinition<TArgs extends unknown[] = unknown[], TData = unknown> = QueryDefinition<TArgs, TData> | MutationDefinition<TArgs, TData>;
...
export type ApiInstance = <TData = unknown>(config: ApiRequestConfig) => Promise<ApiResponse<TData>>;
...
export interface UseScrewQueryResult<TData = unknown, TError = ReactScrewErrorShape> extends QueryState<TData, TError> {
...
export interface UseScrewMutationOptions<TData = unknown, TVariables = unknown> {
    ...
    onError?: (error: ReactScrewErrorShape, variables: TVariables | undefined) => void | Promise<void>;
    onSettled?: (data: TData | undefined, error: ReactScrewErrorShape | null, variables: TVariables | undefined) => void | Promise<void>;
    optimisticUpdate?: (context: OptimisticUpdateContext<TVariables>) => Promise<RollbackAction | void> | RollbackAction | void;
}
export interface UseScrewMutationResult<TData = unknown, TVariables = unknown, TError = ReactScrewErrorShape> extends MutationState<TData, TError> {
    mutate: (variables?: TVariables, ...args: unknown[]) => Promise<TData>;
    mutateAsync: (variables?: TVariables, ...args: unknown[]) => Promise<TData>;
    reset: () => void;
}
export interface LegacyUseScrewResult<TData = unknown, TError = ReactScrewErrorShape> extends QueryState<TData, TError> {
    refetch: () => Promise<TData>;
...
export interface RequestEvent {
    type: 'query:start' | 'query:success' | 'query:error' | 'query:invalidate' | 'mutation:start' | 'mutation:success' | 'mutation:error';
    screwName: string;
    methodName: string;
    queryKey?: QueryKey;
    mutationKey?: string;
...
export interface InfiniteQueryObserverOptions<TPageData = unknown, TPageParam = unknown> extends QueryObserverOptions<unknown[], TPageData[]> {
    initialPageParam: TPageParam;
    getNextPageParam: (lastPage: TPageData, allPages: TPageData[], lastPageParam: TPageParam) => TPageParam | undefined;
}
export interface UseInfiniteScrewQueryResult<TPageData = unknown, TError = ReactScrewErrorShape, TPageParam = unknown> extends UseScrewQueryResult<TPageData[], TError> {
